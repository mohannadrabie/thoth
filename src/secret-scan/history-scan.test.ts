...
// gone, so the invariant is inverted and now holds by construction: NO blob is skipped, whatever its
// bytes. It is tested on generated bytes at every position instead of on this repo's tracked files. The
